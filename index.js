...
const allowedOrigins = ['http://localhost:5173', 'https://staging.dyjs76ge1s6pf.amplifyapp.com', 'https://staging.dyjs76ge1s6pf.amplifyapp.com/']; // Add your frontend's origin
